...
const About = () => {
  ...
  const maskText = `Hey! I'm a Creative Designer, a web enthusiast on a mission to make every website I build faster, smoother, and more fun. I love experimenting with new tech, and when I'm not designing, you can catch me learning new tricks or catching up on the latest trends.`;

  const underText = `Hey there! I'm a Creative Designer, a self-proclaimed web wizard on a mission to make the internet a better place—one dynamic website at a time. When I'm not creating, you can find me binge-watching design tutorials or battling creative blocks that come my way.`;
