    ...
    >
      <div className="w-full lg:w-2/5 text-4xl lg:text-5xl font-semibold flex flex-col p-0 lg:p-8">
        ...
        <p className="faq-p text-sm lg:text-lg font-light text-primary/80 mt-1 lg:mt-4 max-w-md flex flex-wrap">
          {`Here are answers to some frequently asked questions about my design process, approach, and creative philosophy. If you're curious about how I work or what I can do for your project, you'll find your answers here.`
            .split(" ")
            .map((word, index) => (
            ...
            <Btn
              title={
                <span className="flex items-center gap-2">
                  More Questions <FaRegCommentDots />
                </span>
              }
              subTitle={
                <span className="flex items-center gap-2">
              ...
              link={"/contact"} // Changed to internal contact page
              type={"transparent"}
